import * as server from '../entries/pages/esami/_esami_/_page.server.ts.js';

export const index = 4;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/esami/_esami_/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/esami/[esami]/+page.server.ts";
